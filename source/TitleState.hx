...
class TitleState extends MusicBeatState
{
	...
	#if TITLE_SCREEN_EASTER_EGG//Funny
	var easterEggKeys:Array<String> = [
		'SHADOW', 'RIVER', 'SHUBS', 'BBPANZU', 'MONIKA', 'GOLD', 'SLIVER'
	];
	...
	function startIntro()
	{
		...
		switch(easterEgg.toUpperCase())
		{
			...
			//CRY ABOUT IT :)
			case 'MONIKA':
				gfDance.frames = Paths.getSparrowAtlas('characters/big_monikia_base');
				gfDance.animation.addByPrefix('danceLeft', 'Big Monika Idle', 24, false);
				gfDance.animation.addByPrefix('danceRight', 'Big Monika Idle', 24, false);
			case 'SLIVER'|'GOLD':
				gfDance.frames = Paths.getSparrowAtlas('characters/Lost Silver Assets Gold');
				gfDance.animation.addByPrefix('danceLeft', 'Silver Idle', 24, false);
				gfDance.animation.addByPrefix('danceRight', 'Silver Idle', 24, false);
			#end
